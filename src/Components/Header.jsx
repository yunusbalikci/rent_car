    ...
    return (
        <div className="w-full flex flex-col md:flex-row p-4 border-red-700 font-open border-b-2 border-opacity-45">
            <div className="md:ml-20 flex flex-col md:flex-row md:space-x-16 items-center">
                ...
                <div className="invisible md:visible flex md:pl-20 mt-2 cursor-pointer space-x-6 md:space-x-16">
            ...
            <div className="flex mt-4 md:mt-0 md:pl-20 pb-1">
                <button className="text-white text-xl ml-4 md:ml-0 bg-red-500 w-full md:w-32 md:mr-6 shadow-xl shadow-red-200 font-bold rounded-md mb-2 md:mb-0">LOG IN</button>
                <button className="text-zinc-950 text-xl mb-2 md:mb-0 font-bold w-full md:w-auto">SIGN UP</button>
            </div>
        </div>
    );
}
